...
func (r *rejectHandler) OnNetworkConnection(_ net.Addr) (sshserver.NetworkConnectionHandler, error) {
...
func (f *fullHandler) OnNetworkConnection(_ net.Addr) (sshserver.NetworkConnectionHandler, error) {
